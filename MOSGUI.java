...
public class MOSGUI {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		while (!login.contentEquals("quit")) {
			 ...
			 * "ID was not found in database. Please try again", "Error",
			 * JOptionPane.ERROR_MESSAGE);
			...
			if (ID.charAt(0) == doc_num) {
				...
				if (choice == JOptionPane.YES_OPTION) {
					...
					JOptionPane.showMessageDialog(null, schedule_x.printSchedule(), "Schedule",
							JOptionPane.INFORMATION_MESSAGE);
					...
					if (ID.charAt(0) == doc_num) {
						...
						writeDoctorNotes.append("Patient ID:" + p_id + " Drug Id:" + drug_id + " Dosage:" + dosage +
								" Doctor Lastname:" + dr_last + " Nurse Lastname:" + nurse_last + " Pick Up Time:"
								+ pickup_d + "\n");
